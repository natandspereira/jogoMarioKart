...
async function playerRaceEngine(character1, character2){
    for(let round=1; round <= 5; round++){
        ...
        if(block === "RETA"){
            ...
            await logRollResult(character1.NOME, "velocidade", diceResult1, character1.MANOBRABILIDADE);
            await logRollResult(character2.NOME, "velocidade", diceResult2, character2.MANOBRABILIDADE);
        }
        if(block === "CURVA"){
